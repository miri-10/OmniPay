...
const CodeBlock: React.FC<CodeBlockProps> = ({ code }) => (
    <pre className="bg-slate-900 border border-slate-700 rounded-lg p-4 overflow-x-auto my-4">
        <code className="text-purple-400 text-sm font-mono">{code}</code>
    </pre>
);

const FeatureCard: React.FC<FeatureCardProps> = ({ icon: Icon, title, description, items }) => (
    <div className="group p-6 bg-slate-900/50 border border-purple-500/20 rounded-2xl backdrop-blur-sm hover:border-purple-500/60 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

        <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-fuchsia-500 rounded-lg flex items-center justify-center shadow-lg shadow-purple-500/50">
        ...
        <div className="border-b border-slate-800/50">
            ...
            >
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center group-hover:from-purple-500/40 group-hover:to-fuchsia-500/40 transition-all">
                        <Icon className="w-6 h-6 text-purple-400" />
                    </div>
                    <h2 className="text-2xl font-bold text-white group-hover:text-purple-400 transition-colors">{title}</h2>
                </div>
                <ChevronDown
            ...
            {expandedSections[id] && (
                <div className="px-6 pb-6 pt-2 border-t border-slate-800/30 bg-slate-900/20 to-transparent">
                    {children}
                </div>
            )}
        </div>
            ...
            <main className="max-w-7xl mx-auto pb-20 px-6 pt-32">
                ...
                <Section id="intro" title="Getting Started" icon={BookOpen}>
                    <div className="space-y-4 text-slate-300">
                        <p>
                            <span className="text-purple-400 font-bold">OmniPay</span> is an innovative decentralized application (DApp) designed for seamless payroll management using blockchain technology powered by Solana&apos;s Rust programming language.
                        </p>
                        <p>
                ...
                <Section id="quickstart" title="Quick Start Guide" icon={Zap}>
                    <div className="space-y-8">
                        ...
                        <div className="p-6 bg-purple-900/40 via-purple-900/40 to-slate-900/40 border border-purple-500/50 rounded-2xl backdrop-blur-sm">
                            <div className="flex gap-4">
                                <AlertCircle className="w-8 h-8 text-purple-400 shrink-0" />
                                <div>
<h3 className="text-xl font-bold text-purple-300 mb-3">Required: You Need a Groq API Key</h3>
                                    <p className="text-slate-200 text-sm leading-relaxed">
                                        ...
                                        1. Go to → <a href="https://console.groq.com/keys" target="_blank" rel="noopener" className="text-purple-400 underline hover:text-white">console.groq.com/keys</a><br />
                            ...
                            <div className="overflow-x-auto rounded-lg border border-slate-700">
                                <table className="w-full text-sm text-left text-slate-300">
                                    ...
                                    <tbody className="divide-y divide-slate-700">
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">List all organizations</td><td className="px-6 py-4 font-mono text-purple-400">Show my organizations</td><td className="px-6 py-4">Shows treasury balances</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">View org details</td><td className="px-6 py-4 font-mono text-purple-400">Show details for Tesla</td><td className="px-6 py-4">Workers, salaries, last paid</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Create organization</td><td className="px-6 py-4 font-mono text-purple-400">Create organization Apple</td><td className="px-6 py-4">Instantly created</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Add worker</td><td className="px-6 py-4 font-mono text-purple-400">Add worker 7yQ... to Tesla salary 3.5 SOL</td><td className="px-6 py-4">Worker added</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Fund treasury</td><td className="px-6 py-4 font-mono text-purple-400">Fund Tesla with 20 SOL</td><td className="px-6 py-4">SOL transferred</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Pay everyone</td><td className="px-6 py-4 font-mono text-purple-400">Process payroll for Tesla</td><td className="px-6 py-4">All workers paid</td></tr>
                                        <tr className="hover:bg-slate-800/50"><td className="px-6 py-4">Withdraw</td><td className="px-6 py-4 font-mono text-purple-400">Withdraw 8 SOL from Tesla</td><td className="px-6 py-4">Sent to your wallet</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    <div key={item.step} className="flex gap-4 p-4 bg-slate-800/30 rounded-lg border border-slate-700/50 hover:border-purple-500/30 transition-all">
                                        <div className="w-8 h-8 bg-gradient-to-br from-purple-500 to-fuchsia-500 rounded-lg flex items-center justify-center shrink-0 text-black font-bold text-sm">
                                            {item.step}
                                        </div>
                                        <div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={i} className="p-4 bg-slate-800/50 rounded-lg border border-slate-700/50 hover:border-purple-500/30 transition-all">
                                        <div className="flex items-start justify-between mb-2">
                                            <h4 className="font-mono font-bold text-purple-400">{fn.name}</h4>
                                            <span className="px-2 py-1 text-xs bg-purple-500/20 text-purple-400 rounded">Function</span>
                                        </div>
                                        <p className="text-sm text-slate-300 mb-2">{fn.desc}</p>
                                        <div className="grid grid-cols-2 gap-2 text-xs">
                                            <div><span className="text-slate-400">Parameters:</span><p className="text-purple-400">{fn.params}</p></div>
                                            <div><span className="text-slate-400">Returns:</span><p className="text-purple-400">{fn.returns}</p></div>
                                        </div>
                                    </div>
                                ))}
                            </div>
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="text-slate-300 mb-4">
                                Navigate to the <span className="text-purple-400">/playground</span> page to access a comprehensive test interface with all blockchain functions.
                            </p>
                ...
                <Section id="mobile" title="Mobile & Tablet Experience" icon={Smartphone}>
                    <div className="space-y-4 text-slate-300">
                        ...
                        <ul className="space-y-3 ml-4">
                            <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-purple-400 shrink-0 mt-0.5" /> The organizations panel is hidden by default</li>
                            <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-purple-400 shrink-0 mt-0.5" /> Tap the <strong>glowing menu button</strong> (bottom-right or top-right) to open it</li>
                            <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-purple-400 shrink-0 mt-0.5" /> Chat takes full width for easier typing</li>
                            <li className="flex items-start gap-3"><CheckCircle className="w-5 h-5 text-purple-400 shrink-0 mt-0.5" /> Swipe the panel away when done</li>
                        </ul>
                ...
                <div className="mt-12 p-6 bg-slate-900/50 border border-purple-500/20 rounded-2xl">
                ...
                <div className="mt-12 grid md:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={i} className="p-4 bg-slate-900/50 border border-slate-800 rounded-lg text-center hover:border-purple-500/30 transition-all">
                            <div className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent mb-1">
                                {stat.value}
                            </div>
