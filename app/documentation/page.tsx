            ...
            <main className="max-w-7xl mx-auto pb-20 px-6 pt-32">
                ...
                <Section id="intro" title="Getting Started" icon={BookOpen}>
                    <div className="space-y-4 text-slate-300">
                        <p>
                            <span className="text-[#DC1FFF] font-bold">OmniPay</span> is an innovative decentralized application (DApp) designed for seamless payroll management using blockchain technology powered by Solana&apos;s Rust programming language.
                        </p>
                        <p>
