...
export default function PrivacyPage() {
        ...
        },
        {
            ...
            content: (
                <ul className="space-y-4 text-slate-400">
                    <li className="flex items-start gap-4 p-4 bg-slate-800/40 rounded-xl border border-fuchsia-500/20">
                        <EyeOff className="w-6 h-6 text-fuchsia-400 shrink-0 mt-1" />
                        <div>
                    ...
                    <li className="flex items-start gap-4 p-4 bg-slate-800/40 rounded-xl border border-fuchsia-500/20">
                        <Zap className="w-6 h-6 text-fuchsia-400 shrink-0 mt-1" />
                        <div>
                            <strong className="text-white">Deleted on page leave</strong>
                            <p className="text-sm mt-1">Close tab, refresh, or navigate away — key is instantly wiped.</p>
                        </div>
                    </li>
                    <li className="flex items-start gap-4 p-4 bg-slate-800/40 rounded-xl border border-fuchsia-500/20">
                        <Lock className="w-6 h-6 text-fuchsia-400 shrink-0 mt-1" />
                        <div>
                ...
                <>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        <div className="p-5 bg-slate-800/40 rounded-xl border border-slate-700">
                            <Wallet className="w-8 h-8 text-violet-400 mb-3" />
                        ...
                        <div className="p-5 bg-slate-800/40 rounded-xl border border-slate-700">
                            <EyeOff className="w-8 h-8 text-violet-400 mb-3" />
                    ...
                    <p className="text-sm text-slate-500 mt-6 p-4 bg-slate-900/50 rounded-lg border border-slate-800">
                        <Shield className="w-4 h-4 inline mr-2 text-fuchsia-400" />
        ...
        },
        {
            ...
            content: (
                <div className="text-slate-400 space-y-4">
                    ...
                    <p className="mt-6 p-4 bg-slate-800/50 rounded-lg border border-fuchsia-500/30">
                        Questions? Reach out anytime: <a href="mailto:contact@dappmentors.org" className="text-fuchsia-400 hover:text-white underline">contact@dappmentors.org</a>
                    </p>
                </div>
            )
        },
    ...
    return (
        <div className="min-h-screen bg-[#0a0512] relative overflow-hidden">
            ...
            {/* Gradient Orbs */}
            <div className="absolute top-40 left-10 w-96 h-96 bg-purple-500/20 rounded-full blur-[120px] animate-pulse" />
            ...
            <section className="relative z-10 pt-32 pb-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-5xl sm:text-6xl font-bold bg-gradient-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent mb-6">
                        Privacy Policy
                    </h1>
            ...
            <section className="relative z-10 py-20 px-6">
                <div className="max-w-4xl mx-auto space-y-12">
                    {sections.map((section, i) => (
                        <div
                            key={i}
                            className="group p-8 bg-slate-900/60 rounded-2xl border border-slate-700/50 backdrop-blur-sm hover:border-purple-500/50 transition-all duration-500"
                        >
                            <div className="flex items-start gap-5 mb-6">
                                <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${section.bgColor} flex items-center justify-center group-hover:scale-110 transition-transform`}>
                    ...
                    <div className="text-center pt-12">
                        <p className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent">
