...
SOLANA EXPLORER LINKS:
  ...
  return (
    <div className="min-h-screen bg-transparent">
      ...
      {!publicKey && (
        <div className="relative z-40 p-3 sm:p-4 bg-white/5 border border-white/10 text-white/70 rounded-lg text-xs sm:text-sm max-w-[90vw] sm:max-w-none backdrop-blur-sm mx-4 mt-4">
        ...
        <div className="w-full min-h-[calc(100vh-12rem)] flex flex-col lg:flex-row gap-4 sm:gap-6">
          ...
          {!isPayrollOpen && (
            <button
              ...
              className="fixed right-4 sm:right-6 bottom-20 p-3 bg-white text-black rounded-xl shadow-lg transition-all duration-200 z-40"
