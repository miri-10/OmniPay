                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 mb-8 sm:mb-12">
                    ...
                    <div className="sm:col-span-2 lg:col-span-2">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href="mailto:hello@omnipay.com" className="group text-sm sm:text-base text-slate-400 hover:text-[#00FFA3] transition-all duration-300 flex items-center gap-2">
                                    <span className="w-0 h-0.5 bg-[#00FFA3] group-hover:w-2 transition-all duration-300" />
                                    Contact
                                </Link>
                            </li>
